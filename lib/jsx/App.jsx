      ...
      <div className="slides">
        ...
        <section>
          ...
          <section>
            ...
            <p className="fragment fade-up">fade-up (also down, left and right!)</p>
            <p className="fragment current-visible">current-visible</p>
            <p>Highlight <span className="fragment highlight-red">red</span> <span className="fragment highlight-blue">blue</span> <span className="fragment highlight-green">green</span></p>
          </section>
        </section>
